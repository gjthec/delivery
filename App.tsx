...
import { Search, Mic, Sparkles, Filter, X, ShoppingBag, ChefHat, ArrowRight, CheckCircle2, PlusCircle, User, Heart, Home, Star, Wand2, Wallet, Leaf, Zap, History } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 transition-colors duration-300 pb-40">
      ...
      {lastAddedItem && (
        <div className="fixed bottom-32 left-4 right-4 z-[100] bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 p-4 rounded-2xl shadow-2xl flex items-center justify-between animate-slide-up">
        ...
        <section className="px-6 pt-28 pb-4 bg-gradient-to-b from-orange-50/50 dark:from-orange-950/10 to-transparent">
          <div className="mb-6">
            <div className="inline-flex items-center gap-2 bg-orange-100/50 dark:bg-orange-500/10 px-3 py-1.5 rounded-full mb-3 border border-orange-200/50 dark:border-orange-500/20 animate-pulse">
              <Wand2 size={12} className="text-orange-600 dark:text-orange-400" />
              <span className="text-[10px] font-black text-orange-600 dark:text-orange-400 uppercase tracking-[0.15em]">Inteligência Gastronômica</span>
            </div>
            <h1 className="text-[2.5rem] font-[900] tracking-tighter leading-[0.95] mb-4 text-zinc-900 dark:text-zinc-50">
              O que você quer <br/> <span className="text-orange-500 italic">sentir hoje?</span>
            </h1>
          </div>
          ...
          <div className="relative group mb-2">
            ...
            <input
              ...
              placeholder='Ex: "Combo para 2 pessoas"'
              value={searchQuery}
            ...
            <button 
              ...
              className="absolute right-2 top-2 bottom-2 px-6 orange-gradient text-white rounded-[1.4rem] font-black text-[10px] tracking-widest uppercase disabled:opacity-30 active:scale-95 transition-all shadow-lg"
            >
              {isAiLoading ? '...' : 'PEDIR'}
            </button>
          </div>
          ...
          <section className="mt-8 px-6 mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">IA Powered</p>
              </div>
